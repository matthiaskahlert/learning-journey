...
import json
TEXT_DATEI = 'python/exercises/Teilprüfung 03 lokal/namen.txt' # bitte berücksichtigen, dass es sich hier um meinden relativen path meiner lokalen Ordnerstruktur handelt
# TEXT_DATEI = 'namen.txt'
JSON_DATEI = 'python/exercises/Teilprüfung 03 lokal/namen.json' # bitte berücksichtigen, dass es sich hier um meinden relativen path meiner lokalen Ordnerstruktur handelt
...
def hauptmenü():
    ...
    while True:
        ...
        if wahl == '1':
            print("Namen aus Textdatei wurden geladen!")
...
if __name__ == "__main__": # sorgt für ausführung per script aber nicht bei modulimport. dort wird der modulname gesetzt und der if block übersprungen
    ...
    if TESTS_AKTIV:
            ...
            if test_namen:
                ...
                print("(Erstellen Sie eine 'namen.txt' Datei mit Namen, jeweils einer pro Zeile)")
