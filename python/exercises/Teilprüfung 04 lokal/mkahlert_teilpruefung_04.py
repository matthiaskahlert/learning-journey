...
c) Zähle, wie oft jedes Datum vorkommt, und speichere die Ergebnisse in einem Dictionary, wobei das Datum der Schlüssel und die Anzahl der Vorkommen der Wert ist.
...
f) Implementiere eine Fehlerbehandlung mit try und except, um elegante Lösungen für mögliche I/O-Fehler und Probleme beim Arbeiten mit Dateien zu bieten.
...
FEEDBACK_DATEI = 'python/exercises/Teilprüfung 04/feedback.txt'
DATUMS_JSON = 'python/exercises/Teilprüfung 04/datums_vorkommen.json'
EXZELLENTE_JSON = 'python/exercises/Teilprüfung 04/exzellente_feedbacks.json'
